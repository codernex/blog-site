...
const LocationInput = ({ country, rules }) => {
    ...
    return (
        <>
            ...
            >
                {site?.isGoogleMapLoaded && <MapSelector country={country} />}
            </Form.Item>
        ...
        <>
            ...
            <div className="relative">
                <Autocomplete
                    ...
                    children={<input
                        className="form-control mb-4 !pr-10"
                        value={value?.name}
                        onChange={(e) => {
                            onChange({
                                ...value,
                ...
                <MdOutlineMyLocation
                    ...
                    size={18}
                    className="absolute top-1/2 right-3 transform -translate-y-1/2 text-dark_color" />
            </div>

...
export const showLoader = () => (document.getElementById("main-loader") ? document.getElementById("main-loader").classList.remove("hidden") : console.error("Element with ID 'main-loader' not found"));

export const hideLoader = () => (document.getElementById("main-loader") ? document.getElementById("main-loader").classList.add("hidden") : console.error("Element with ID 'main-loader' not found"));
